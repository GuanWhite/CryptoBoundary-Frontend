...
export default function ContactListCard() {
  return (
    <div>
      <div className="flex items-center p-3 w-72 h-28 bg-[#e5e5e5] hover:bg-[#d8d8d8] dark:bg-white shadow-lg">
        ...
        <section className="block border-l border-gray-300 m-3">
          <div className="pl-3">
            <h3 className="text-gray-600 font-semibold text-sm">Jesus Echeverria</h3>
