...
const InputBox = () => {
  ...
  return (
    ...
    <div className='bg-[#F3F4F6] dark:bg-[#404045] h-fit w-full rounded-2xl p-4'>
      <div className="bg-[#F3F4F6] dark:bg-[#404045] h-fit w-full p-2">
        <TextArea
          className="font-fontFamily border-none text-base bg-[#F3F4F6] hover:bg-[#F3F4F6] focus:bg-[#F3F4F6] dark:bg-[#404045] dark:hover:bg-[#404045] dark:focus:bg-[#404045] dark:text-[#f5f5f5] focus:shadow-none placeholder:text-slate-400"
          value={value}
      ...
      <div className="relative bg-[#F3F4F6] dark:bg-[#404045] h-8 w-full p-2">
        ...
        <Button
          type="primary"
          className="absolute inset-y-0 right-0 h-full w-20 mr-2 rounded-full bg-[#4d6bfe]"
