...
export default function SideBar() {
  return (
    <div className='min-h-screen w-[210px] flex flex-col dark:bg-[#171717] bg-[#f9f9f9] '>
      {/* 工具箱 */}
      <div className="flex justify-end items-center px-[8px] h-[56px]">
        <button className="hover:bg-[#e7e7e7] dark:hover:bg-[#3a3a3a] size-[40px] rounded-lg px-2">
