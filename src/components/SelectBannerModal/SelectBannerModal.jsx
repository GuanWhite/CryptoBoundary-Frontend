...
import { Button, ColorPicker, Modal, Upload, message } from "antd";
...
export default function SelectBannerModal({
  ...
  const [colorHex, setColorHex] = useState(bannerColor);
        ...
        <div className='w-full flex justify-start my-[20px]'>
          <div className='mr-[15px] flex flex-col justify-center gap-3'>
            ...
            >
              <label
                htmlFor="file"
                className="h-[200px] w-[230px] flex flex-col gap-5 cursor-pointer items-center justify-center border-2 border-dashed border-gray-300 bg-white py-6 px-[10px] rounded-[10px] shadow-[0px_48px_35px_-48px_rgba(0,0,0,0.1)]"
              >
